    ...
    if (!product) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center font-['Inter']">
                ...
                <button onClick={() => navigate('/seller/products')} className="text-xs font-semibold text-white bg-gray-900 px-4 py-2 rounded-lg">Back to Products</button>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50 font-['Inter'] flex flex-col">
            ...
            <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 flex items-center justify-between px-8 h-[60px]">
                <div className="flex items-center gap-4">
                    <button onClick={() => { if (window.history.length > 1) { navigate(-1); } else { navigate('/seller/products'); } }} className="p-2 -ml-2 rounded-full hover:bg-gray-100 transition-colors">
